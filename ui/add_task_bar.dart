...
import 'package:newtask/controller/task_controller.dart';
...
import 'package:newtask/ui/widgets/input_field.dart';
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Expanded(
                      child:MyInputField(title: "Start Date",
                      hint:_startTime ,
                      widget: IconButton(
                        onPressed: (){
                  ...
                  SizedBox(width: 12,),
                  Expanded(
                      child:MyInputField(title: "End Date",
                        hint:_endTime ,
                        widget: IconButton(
                          onPressed: (){
                  ...
                  ),// Expanded(child: MyInputField(title: "Start Date", hint: ,))
                ],
              ),
              MyInputField(title: "Remind", hint: "$_selectedRemind minuts early",
          ...
          List<Widget>.generate(
            ...
            return GestureDetector(
              ...
              child: Padding(
                ...
                child: CircleAvatar(
                  radius: 14,
                  backgroundColor: index ==0?Colors.indigo:index==1?Colors.pinkAccent:Colors.orange,
